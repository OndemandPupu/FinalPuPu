...
<body>
  <div id="wrap">
    <div id="cart_layout_1">
      ...
      <div class="complete_cart fontsize">
        <div class="updated">
        <div class="shipping">
          <h2>Shipping Estimate</h2>
          <div class="state fontsize">
            <select id="state">
        ...
        <div class="coupon fontsize">
          <h2>Coupon Code</h2>
          <input id="code"></input>
        <a class="button update fontsize">Update Cart</a>
        </div>
        </div>
        <div class="checkout fontsize">
          <div class="total fontsize">
          <h2>Subtotal:</h2>
          <span class="sub fontsize">
