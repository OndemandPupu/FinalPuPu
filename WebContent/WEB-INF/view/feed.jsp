				...
				<div class="column col-sm-3" id="sidebar">
					...
					<ul class="nav">
						<li>
							...
							<p>
								<button class="btn" id="btn" type="submit">
									...
									<img class="btn-img"
										src="/users/cc7de1bf-865a-41ca-b903-4ff39559e204"
						...
						<li class="active"><a href="#featured"><i
								class="glyphicon glyphicon-home"></i>내정보</a></li>
						<li><a href="#stories"><i
								class="glyphicon glyphicon-user"></i>내이야기</a></li>
					</ul>
					<ul class="nav hidden-xs" id="sidebar-footer">
						<li><a href=""><h3>Want you!</h3> 만든이 <i class="glyphicon glyphicon-off"></i> by Team Pupu</a></li>
					</ul>
				</div>
				<!-- /sidebar -->
						...
						<div class="full col-sm-9">
							...
							<div class="col-sm-12" id="featured">
								<div class="page-header text-muted">
									<i class="glyphicon glyphicon-pencil"></i> <b>${DATA }</b>
							...
							<div class="row">
								<div class="col-sm-10">
									...
									<h3>수용아 이거 어떠냐</h3>
									<h4>
										<span class="label label-default">techvisually.com</span>
									</h4>
									<h4>
							...
							<div class="row">
								<div class="col-sm-10">
									...
									<h4>
										<span class="label label-default">searchenginewatch.com</span>
									</h4>
							...
							<div class="row">
								<div class="col-sm-10">
									...
									<h4>
										<span class="label label-default">devgarage.com</span>
									</h4>
									<h4>
										<small class="text-muted">2 days ago • <a href="#"
											class="text-muted">Read More</a></small>
									</h4>
								</div>
								<div class="col-sm-2">
							...
							<div class="row">
								<div class="col-sm-10">
									<h3>완전 좋음 이거 추천</h3>
									<h4>
										<span class="label label-default">bootply.com</span>
									</h4>
									<h4>
										<small class="text-muted">3 days ago • <a href="#"
											class="text-muted">Read More</a></small>
									</h4>
								</div>
								<div class="col-sm-2">
									<a href="#" class="pull-right"><img
										src="http://api.randomuser.me/portraits/thumb/women/17.jpg"
										class="img-circle"></a>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-10">
									...
									<h4>
										<small class="text-muted">4 days ago • <a href="#"
											class="text-muted">Read More</a></small>
									</h4>
								</div>
							...
							<div class="col-sm-12">
								<div class="page-header text-muted divider">Up Next</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="page-header text-muted divider">Connect with
									Us</div>
							</div>
